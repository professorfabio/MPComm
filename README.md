...
A second server process, running GroupManager.py, is used for peers to register themselves (notably their IP addresses) as well as to discover the other peers.
